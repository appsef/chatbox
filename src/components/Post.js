...
const Post = ({post}) => {
    ...
    return (
        <div className="flex flex-col justify-evenly content-center px-10 py-4">
            <img src={post.download_url} className="object-cover w-full h-96 rounded-xl "  alt="" />
            ...
            {post.author}</p>
            <a href={post.url} className="font-lexend text-xs bg-black hover:bg-weta w-max px-3 py-2 rounded-lg font-medium text-white mt-4" >
